export const translationsEs: Record<string, string> = {
  ...
  helpBack: "Volver",
  helpIntro: "Respuestas a las preguntas más frecuentes. Si no encuentras lo que buscas, contáctanos en GitHub.",
  helpGettingStartedTitle: "Primeros pasos",
  helpGettingStartedContent: "Después de crear una cuenta, ve a \"Cuentas\" y conecta tus bancos seleccionando el país y la institución. La conexión se realiza a través de proveedores certificados — tus credenciales nunca pasan por nuestros servidores.\n\nUna vez conectado, las transacciones se importan automáticamente dos veces al día. También puedes sincronizar manualmente haciendo clic en el icono de sincronización.",
  helpPageTransactionsTitle: "Transacciones y categorías",
  helpTransactionsContent: "Las transacciones se categorizan automáticamente con IA. Puedes corregir cualquier categoría haciendo clic en ella — el sistema aprende de tus correcciones con el tiempo.\n\nPuedes añadir etiquetas para organizar transacciones por proyecto, persona o tipo (personal/empresa). Las etiquetas también son útiles para filtrar y exportar informes.",
  helpSubscriptionTitle: "Suscripción",
  helpSubscriptionContent: "La aplicación incluye un período de prueba gratuito. Después, se requiere una suscripción activa para conectar bancos automáticos y recibir actualizaciones diarias.\n\nPuedes gestionar tu suscripción en \"Mi perfil\" → pestaña \"Suscripción\". Cada suscripción incluye 2 cuentas automáticas; puedes añadir más por 0,75 €/mes cada una.",
  helpSupportTitle: "¿Necesitas más ayuda?",
  helpSupportBody: "¿No encontraste una respuesta? Reporta un error o sugiere una nueva función directamente en GitHub.",
