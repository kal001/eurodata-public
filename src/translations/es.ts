export const translationsEs: Record<string, string> = {
  ...
  pricingFeatureExportExcel: "Exportar transacciones a Excel",
  ...
  pricingFeatureServersGermany: "Servidores de datos en Europa (Alemania)",
  ...
  pricingFaq4A:
    "Tus datos se almacenan cifrados en servidores en Alemania. También puedes optar por almacenamiento solo local.",
