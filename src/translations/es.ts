export const translationsEs: Record<string, string> = {
  ...
  heroBody:
    "Conecta bancos y tarjetas en toda Europa.\nNunca vemos ni vendemos tus datos bancarios—se almacenan solo para ti, cifrados, con proveedores de nivel bancario. Servidores en Europa. Cliente en código abierto que puedes inspeccionar en GitHub.\n\nAsigna categorías a las transacciones de forma automática. Asigna etiquetas. Detecta automáticamente transacciones recurrentes.",
  ...
  privacyHighlight5: "Los servidores de la aplicación están en Europa.",
  ...
  adminBroadcastInvalidSourceLang:
    "El nombre de la plantilla debe terminar en un código de idioma de 2 letras (ej. newsletter_pt)",
  ...
  exportSheetsLinkSuccess: "Cuenta de Google vinculada. Ya puedes exportar a Sheets.",
  exportSheetsSuccess: "Exportado a Google Sheets.",
  exportSheetsError: "No se pudo exportar a Google Sheets. Inténtalo de nuevo o vuelve a vincular tu cuenta de Google.",
  exportSheetsNotConfigured: "La exportación a Google Sheets no está configurada.",
  exportNumberFormat: "Formato de números",
  exportNumberFormatHelp: "Coincida con la configuración de Excel/Sheets para que los importes se vean correctamente.",
  ...
  exportSheetsDestination: "Destino en Google Sheets",
  exportSheetsNew: "Nueva hoja",
  exportSheetsExisting: "Hoja existente",
  exportSheetsFolder: "Carpeta",
  exportSheetsBrowse: "Examinar…",
  exportSheetsMyDrive: "Mi unidad (raíz)",
  exportSheetsSelectExisting: "Hoja",
  exportSheetsSelectOne: "— Seleccione una —",
  exportSheetsExistingHelp: "Solo se añaden transacciones nuevas; los duplicados se omiten.",
  exportSheetsSelectSpreadsheet: "Seleccione una hoja.",
  exportSheetsWaitMessage: "Exportando a Google Sheets… Esta pestaña abrirá su hoja en unos segundos. No la cierre.",
  exportSheetsToastWait: "Exportación iniciada. La nueva pestaña abrirá su hoja cuando esté lista.",
  ...
  helpTxExport: "Exportar",
  helpTxExportDesc: "Exportar transacciones a CSV o Google Sheets.",
  ...
  pricingHeroSubtitle:
    "Prueba eurodata.app gratis 30 días — sin tarjeta de crédito. Después, paga una cuota mensual fija que cubre los costes de infraestructura. No monetizamos tus datos.",
  pricingPlanStandard: "Estándar",
  pricingPlanExtraAccount: "+0,75 € / cuenta adicional",
  pricingVatIncluded: "IVA incluido",
  pricingMostPopular: "Más popular",
  pricingStandardPrice: "2,50 € / mes",
  pricingExtraPrice: "0,75 € / mes por cuenta bancaria adicional",
  pricingStandardDescription: "Todo lo que necesitas para gestionar tus finanzas en Europa.",
  pricingStandardInclude1: "Prueba gratuita de 30 días",
  pricingStandardInclude2: "Hasta 2 cuentas bancarias conectadas",
  pricingStandardInclude3: "Todas las funciones de la app incluidas",
  pricingExtraDescription: "¿Necesitas conectar más bancos? Añade tantas cuentas como necesites.",
  pricingExtraNote: "Añadido al plan Estándar.",
  pricingCtaStartTrial: "Comenzar prueba gratuita",
  pricingFootnote: "Precios con IVA incluido. Sin tasas ocultas. Cancela cuando quieras.",
  pricingFeaturesTitle: "Todo incluido en tu plan",
  pricingPremiumBadge: "Avanzado",
  pricingFeatureCategoryUi: "Interfaz",
  pricingFeatureCategoryGeneral: "General",
  pricingFeatureCategoryTransactions: "Transacciones",
  pricingFeatureCategorySecurity: "Seguridad y privacidad",
  pricingFeatureResponsive: "Interfaz adaptable a escritorio, tablet y móvil",
  pricingFeaturePwa: "App instalable para iOS y Android",
  pricingFeatureLanguages: "Disponible en 8 idiomas",
  pricingFeatureGoogleAuth: "Autenticación con Google",
  pricingFeatureMultiCurrency: "Soporte multimoneda",
  pricingFeatureSharedAccounts: "Cuentas compartidas — invita a una pareja o amigo a una cuenta común",
  pricingFeatureAlertsChannels: "Alertas por Telegram o Slack",
  pricingFeatureTelegramBot: "Bot de Telegram para interactuar con tus cuentas",
  pricingFeatureApi: "API para integrar transacciones bancarias en otras apps",
  pricingFeatureAutoImport: "Importación automática de extractos y transacciones de más de 30 países europeos",
  pricingFeaturePdfImport: "Importar extractos PDF/Excel con detección de transacciones por IA",
  pricingFeatureAutoCategory: "Categorización automática de transacciones con IA",
  pricingFeatureCustomTags: "Etiquetas personalizadas por transacción (ej. personal vs. profesional)",
  pricingFeatureCustomCategories: "Lista de categorías personalizable",
  pricingFeatureAlertsTransactions: "Alertas para transacciones importantes",
  pricingFeatureRecurringDetection: "Detección automática de transacciones recurrentes",
  pricingFeatureCalendarView: "Vista de calendario de transacciones recurrentes",
  pricingFeatureExportExcel: "Exportar transacciones a Excel o Google Sheets",
  pricingFeatureBalanceForecast: "Previsión de saldo de fin de mes",
  pricingFeatureDataEncrypted: "Datos accesibles solo por ti, almacenados cifrados",
  pricingFeatureNeverSell: "Nunca vendemos ni utilizamos tus datos",
  pricingFeatureCredentialsNeverStored: "Las credenciales bancarias nunca son vistas ni almacenadas por la app",
  pricingFeatureAuthExpire90: "Las autorizaciones bancarias expiran automáticamente a los 90 días",
  pricingFeatureIso27001: "Proveedor de datos bancarios conforme a ISO 27001",
  pricingFeatureServersGermany: "Servidores de datos en Europa",
  pricingFeatureStorageChoice: "Elige entre almacenamiento local o en la nube",
  pricingFeatureAiLocal: "Toda la IA se ejecuta localmente — no se envían datos a proveedores externos de IA",
  pricingFaqTitle: "Preguntas frecuentes",
  pricingFaq1Q: "¿La prueba gratuita es realmente gratis?",
  pricingFaq1A: "Sí, 30 días, sin tarjeta de crédito. Tienes acceso a todas las funciones.",
  pricingFaq2Q: "¿Cómo funciona la facturación?",
  pricingFaq2A:
    "Después de la prueba, se factura 2,50 €/mes (IVA incluido) por hasta 2 cuentas bancarias conectadas. Cada cuenta adicional cuesta 0,75 €/mes.",
  pricingFaq3Q: "¿Puedo cancelar en cualquier momento?",
  pricingFaq3A: "Sí. Puedes cancelar en cualquier momento desde la configuración de tu cuenta.",
  pricingFaq4Q: "¿Dónde se almacenan mis datos?",
  pricingFaq4A:
    "Tus datos se almacenan cifrados en servidores en Europa. También puedes optar por almacenamiento solo local.",
  pricingFaq5Q: "¿Venden mis datos?",
  pricingFaq5A: "Nunca. Nuestro modelo de negocio es una suscripción — no tus datos.",
  pricingCtaTitle: "Empieza tu prueba gratuita de 30 días hoy.",
  pricingCtaSubtext: "Sin tarjeta de crédito. Cancela cuando quieras.",
  pricingCtaButton: "Empezar gratis",
  pricingMetaTitle: "Precios — eurodata.app",
  pricingMetaDescription:
    "Precios simples y transparentes para eurodata.app. Prueba gratuita de 30 días, luego 2,50 €/mes con IVA incluido. Conecta tus cuentas bancarias europeas de forma segura.",
  menuAboutUs: "Sobre nosotros",
  menuTerms: "Términos y condiciones",
  menuSupport: "Soporte",
  menuBugReport: "Reportar error",
  menuFeatureRequest: "Solicitar funcionalidad",
  menuHelp: "Ayuda",
  helpPageTitle: "Centro de ayuda",
  helpBack: "Volver",
  helpIntro: "Eurodata te ayuda a seguir tus finanzas personales o empresariales. Conecta tus bancos para importar transacciones automáticamente, categorízalas con IA, analiza ingresos y gastos y configura alertas para pagos recurrentes.",
  helpLoading: "Cargando…",
  helpLoadError: "No se pudo cargar la página de ayuda.",
  helpSupportTitle: "¿Necesitas más ayuda?",
  helpSupportBody: "Si tienes dudas o encuentras un problema: reporta un error, sugiere una función o participa en las discusiones de GitHub.",
  helpBugReportLink: "Reportar un error",
  helpFeatureLink: "Sugerir una función",
  helpGithubLink: "Ver discusiones en GitHub",
  aboutTitle: "Sobre nosotros",
  aboutBack: "Volver",
  aboutLastUpdated: "Última actualización: febrero de 2026",
  aboutIntro:
    "Somos una startup con sede en Portugal, con una firme creencia en la propiedad y la privacidad de los datos de los usuarios. Creemos que permitir el acceso fácil a información financiera personal consolidada ayuda a las personas a tomar decisiones mejor informadas y contribuye a la educación financiera y a la estabilidad financiera a medio plazo.",
