export const translationsPt: Record<string, string> = {
  ...
  heroBody:
    "Ligue bancos e cartões em toda a Europa.\nNunca vemos nem vendemos os seus dados bancários—ficam armazenados só para si, encriptados, com fornecedores de nível bancário. Servidores na Europa. Cliente em código aberto que pode inspecionar no GitHub.\n\nAtribua categorias de forma automática a transações. Atribua etiquetas. Deteta automaticamente transações recorrentes.",
  ...
  privacyHighlight5: "Os servidores da aplicação estão na Europa.",
  ...
  adminBroadcastInvalidSourceLang:
    "O nome do template deve terminar com um código de idioma de 2 letras (ex: newsletter_pt)",
  ...
  exportSheetsLinkSuccess: "Conta Google ligada. Pode exportar para Sheets.",
  exportSheetsSuccess: "Exportado para Google Sheets.",
  exportSheetsError: "Não foi possível exportar para Google Sheets. Tente novamente ou volte a ligar a conta Google.",
  exportSheetsNotConfigured: "Exportação para Google Sheets não está configurada.",
  exportSheetsErrorRedirectUri: "Falha ao ligar Google: o URL de redirecionamento não coincide. Verifique se GOOGLE_SHEETS_REDIRECT_URI está igual ao da Google Cloud Console.",
  exportSheetsErrorInvalidGrant: "Falha ao ligar Google: código inválido ou expirado. Tente novamente.",
  exportSheetsErrorTokenExchange: "Falha ao ligar Google: não foi possível obter acesso. Verifique os logs do servidor e tente novamente.",
  exportNumberFormat: "Formato de números",
  exportNumberFormatHelp: "Corresponda à configuração do Excel/Sheets para os montantes aparecerem corretamente.",
  ...
  exportSheetsDestination: "Destino no Google Sheets",
  exportSheetsNew: "Nova folha",
  exportSheetsExisting: "Folha existente",
  exportSheetsFolder: "Pasta",
  exportSheetsBrowse: "Procurar…",
  exportSheetsMyDrive: "O Meu Drive (raiz)",
  exportSheetsSelectExisting: "Folha",
  exportSheetsSelectOne: "— Selecione uma —",
  exportSheetsExistingHelp: "Só são adicionadas novas transações; duplicados são ignorados.",
  exportSheetsSelectSpreadsheet: "Selecione uma folha.",
  exportSheetsWaitMessage: "A exportar para Google Sheets… Este separador abrirá a sua folha em instantes. Por favor não o feche.",
  exportSheetsToastWait: "Exportação iniciada. O novo separador abrirá a sua folha quando estiver pronto.",
  ...
  helpTxExportDesc: "Exportar transações para CSV ou Google Sheets.",
  ...
  pricingHeroSubtitle:
    "Experimente o eurodata.app gratuitamente durante 30 dias — sem cartão de crédito. Depois, pague uma taxa mensal fixa que cobre os custos de infraestrutura. Não rentabilizamos os seus dados.",
  pricingPlanStandard: "Standard",
  pricingPlanExtraAccount: "+0,75 € / conta adicional",
  pricingVatIncluded: "IVA incluído",
  pricingMostPopular: "Mais popular",
  pricingStandardPrice: "2,50 € / mês",
  pricingExtraPrice: "0,75 € / mês por conta bancária adicional",
  pricingStandardDescription: "Tudo o que precisa para gerir as suas finanças na Europa.",
  pricingStandardInclude1: "Teste gratuito de 30 dias",
  pricingStandardInclude2: "Até 2 contas bancárias ligadas",
  pricingStandardInclude3: "Todas as funcionalidades da app incluídas",
  pricingExtraDescription: "Precisa de ligar mais bancos? Adicione quantas contas precisar.",
  pricingExtraNote: "Acrescido ao plano Standard.",
  pricingCtaStartTrial: "Iniciar teste gratuito",
  pricingFootnote: "Preços com IVA incluído. Sem taxas ocultas. Cancele quando quiser.",
  pricingFeaturesTitle: "Tudo incluído no seu plano",
  pricingPremiumBadge: "Avançado",
  pricingFeatureCategoryUi: "Interface",
  pricingFeatureCategoryGeneral: "Geral",
  pricingFeatureCategoryTransactions: "Transações",
  pricingFeatureCategorySecurity: "Segurança e privacidade",
  pricingFeatureResponsive: "Interface adaptada a Desktop, Tablet e Telemóvel",
  pricingFeaturePwa: "App instalável para iOS e Android",
  pricingFeatureLanguages: "Disponível em 8 idiomas",
  pricingFeatureGoogleAuth: "Autenticação Google",
  pricingFeatureMultiCurrency: "Suporte multi-moeda",
  pricingFeatureSharedAccounts: "Contas partilhadas — convide um parceiro ou amigo para uma conta comum",
  pricingFeatureAlertsChannels: "Alertas via Telegram ou Slack",
  pricingFeatureTelegramBot: "Bot Telegram para interagir com as suas contas",
  pricingFeatureApi: "API para integrar transações bancárias noutras apps",
  pricingFeatureAutoImport: "Importação automática de extratos e transações de mais de 30 países europeus",
  pricingFeaturePdfImport: "Importar extratos PDF/Excel com deteção de transações por IA",
  pricingFeatureAutoCategory: "Categorização automática de transações com IA",
  pricingFeatureCustomTags: "Etiquetas personalizadas por transação (ex.: pessoal vs. profissional)",
  pricingFeatureCustomCategories: "Lista de categorias personalizável",
  pricingFeatureAlertsTransactions: "Alertas para transações importantes",
  pricingFeatureRecurringDetection: "Deteção automática de transações recorrentes",
  pricingFeatureCalendarView: "Vista de calendário das transações recorrentes",
  pricingFeatureExportExcel: "Exportar transações para Excel ou Google Sheets",
  pricingFeatureBalanceForecast: "Previsão de saldo de fim de mês",
  pricingFeatureDataEncrypted: "Dados acessíveis apenas por si, armazenados encriptados",
  pricingFeatureNeverSell: "Nunca vendemos nem utilizamos os seus dados",
  pricingFeatureCredentialsNeverStored: "As credenciais bancárias nunca são vistas nem armazenadas pela app",
  pricingFeatureAuthExpire90: "As autorizações bancárias expiram automaticamente após 90 dias",
  pricingFeatureIso27001: "Fornecedor de dados bancários em conformidade com ISO 27001",
  pricingFeatureServersGermany: "Servidores de dados na Europa",
  pricingFeatureStorageChoice: "Escolha entre armazenamento local ou na nuvem",
  pricingFeatureAiLocal: "Toda a IA funciona localmente — nenhum dado é enviado a fornecedores externos de IA",
  pricingFaqTitle: "Perguntas frequentes",
  pricingFaq1Q: "O teste gratuito é mesmo gratuito?",
  pricingFaq1A: "Sim, 30 dias, sem cartão de crédito. Tem acesso a todas as funcionalidades.",
  pricingFaq2Q: "Como funciona a faturação?",
  pricingFaq2A:
    "Após o teste, é faturado 2,50 €/mês (IVA incluído) para até 2 contas bancárias ligadas. Cada conta adicional custa 0,75 €/mês.",
  pricingFaq3Q: "Posso cancelar quando quiser?",
  pricingFaq3A: "Sim. Pode cancelar a qualquer momento nas definições da conta.",
  pricingFaq4Q: "Onde são armazenados os meus dados?",
  pricingFaq4A:
    "Os seus dados são armazenados encriptados em servidores na Europa. Também pode optar por armazenamento apenas local.",
  pricingFaq5Q: "Vendem os meus dados?",
  pricingFaq5A: "Nunca. O nosso modelo de negócio é uma subscrição — não os seus dados.",
  pricingCtaTitle: "Comece o seu teste gratuito de 30 dias hoje.",
  pricingCtaSubtext: "Sem cartão de crédito. Cancele quando quiser.",
  pricingCtaButton: "Começar gratuitamente",
  pricingMetaTitle: "Preços — eurodata.app",
  pricingMetaDescription:
    "Preços simples e transparentes para eurodata.app. Teste gratuito de 30 dias, depois 2,50 €/mês com IVA incluído. Ligue as suas contas bancárias europeias em segurança.",
  menuAboutUs: "Sobre Nós",
  menuTerms: "Termos e Condições",
  menuSupport: "Apoio",
  menuBugReport: "Reportar erro",
  menuFeatureRequest: "Sugerir funcionalidade",
  menuHelp: "Ajuda",
  helpPageTitle: "Centro de Ajuda",
  helpBack: "Voltar",
  helpIntro: "O Eurodata ajuda-o a acompanhar as suas finanças pessoais ou empresariais. Ligue os seus bancos para importar transações automaticamente, categorize-as com ajuda de IA, analise receitas e despesas, e configure alertas para pagamentos recorrentes.",
  helpLoading: "A carregar…",
  helpLoadError: "Não foi possível carregar a página de ajuda.",
  helpSupportTitle: "Precisa de mais ajuda?",
  helpSupportBody: "Se tiver dúvidas ou encontrar algum problema: reporte um erro, sugira uma funcionalidade ou participe nas discussões no GitHub.",
  helpBugReportLink: "Reportar um erro",
  helpFeatureLink: "Sugerir uma funcionalidade",
  helpGithubLink: "Ver discussões no GitHub",
  aboutTitle: "Sobre Nós",
  aboutBack: "Voltar",
  aboutLastUpdated: "Última atualização: fevereiro de 2026",
  aboutIntro:
    "Somos uma startup sediada em Portugal, com uma forte crença na propriedade dos dados pelos utilizadores e na privacidade. Acreditamos que permitir o acesso fácil a informação financeira pessoal consolidada ajuda os indivíduos a tomar decisões mais informadas e contribui para a literacia e estabilidade financeira a médio prazo.",
