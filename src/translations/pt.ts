export const translationsPt: Record<string, string> = {
  ...
  helpBack: "Voltar",
  helpIntro: "Respostas às perguntas mais frequentes. Se não encontrar o que procura, contacte-nos através do GitHub.",
  helpGettingStartedTitle: "Primeiros passos",
  helpGettingStartedContent: "Depois de criar conta, aceda a \"Contas\" e ligue os seus bancos selecionando o país e a instituição bancária. A ligação é feita através de fornecedores certificados sem que as suas credenciais passem pelos nossos servidores.\n\nApós ligar um banco, as transações são importadas automaticamente duas vezes por dia. Pode também atualizar manualmente clicando no ícone de sincronização.",
  helpPageTransactionsTitle: "Transações e categorias",
  helpTransactionsContent: "As transações são categorizadas automaticamente por IA. Pode corrigir qualquer categoria clicando nela — o sistema aprende com as suas correções ao longo do tempo.\n\nPode adicionar etiquetas para organizar transações por projeto, pessoa ou tipo (pessoal/empresa). As etiquetas são também úteis para filtrar e exportar relatórios.",
  helpSubscriptionTitle: "Subscrição",
  helpSubscriptionContent: "A aplicação inclui um período de avaliação gratuito. Após esse período, é necessária uma subscrição ativa para ligar bancos automáticos e receber atualizações diárias.\n\nPode gerir a sua subscrição em \"O meu perfil\" → separador \"Subscrição\". Cada subscrição inclui 2 contas automáticas; pode adicionar mais por um custo reduzido por mês.",
  helpSupportTitle: "Precisa de mais ajuda?",
  helpSupportBody: "Não encontrou resposta? Reporte um erro ou sugira uma nova funcionalidade diretamente no GitHub.",
