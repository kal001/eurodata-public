export const translationsPt: Record<string, string> = {
  ...
  pricingFeatureExportExcel: "Exportar transações para Excel",
  ...
  pricingFeatureServersGermany: "Servidores de dados na Europa (Alemanha)",
  ...
  pricingFaq4A:
    "Os seus dados são armazenados encriptados em servidores na Alemanha. Também pode optar por armazenamento apenas local.",
