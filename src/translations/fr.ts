export const translationsFr: Record<string, string> = {
  ...
  footerMadeInPortugal: "Fait au Portugal",
  footerGithub: "GitHub",
  ...
  helpBack: "Retour",
  helpIntro: "Réponses aux questions les plus fréquentes. Si vous ne trouvez pas ce que vous cherchez, contactez-nous sur GitHub.",
  helpGettingStartedTitle: "Premiers pas",
  helpGettingStartedContent: "Après avoir créé un compte, accédez à \"Comptes\" et connectez vos banques en sélectionnant votre pays et votre institution. La connexion se fait via des fournisseurs certifiés — vos identifiants ne transitent jamais par nos serveurs.\n\nUne fois connecté, les transactions sont importées automatiquement deux fois par jour. Vous pouvez aussi synchroniser manuellement en cliquant sur l'icône de synchronisation.",
  helpPageTransactionsTitle: "Transactions et catégories",
  helpTransactionsContent: "Les transactions sont catégorisées automatiquement par IA. Vous pouvez corriger n'importe quelle catégorie en cliquant dessus — le système apprend de vos corrections au fil du temps.\n\nVous pouvez ajouter des étiquettes pour organiser les transactions par projet, personne ou type (personnel/entreprise). Les étiquettes sont aussi utiles pour filtrer et exporter des rapports.",
  helpSubscriptionTitle: "Abonnement",
  helpSubscriptionContent: "L'application inclut une période d'essai gratuite. Après cela, un abonnement actif est nécessaire pour connecter des banques automatiques et recevoir des mises à jour quotidiennes.\n\nVous pouvez gérer votre abonnement dans \"Mon profil\" → onglet \"Abonnement\". Chaque abonnement inclut 2 comptes automatiques ; vous pouvez en ajouter d'autres pour 0,75 €/mois chacun.",
  helpSupportTitle: "Besoin d'aide supplémentaire ?",
  helpSupportBody: "Vous n'avez pas trouvé de réponse ? Signalez un bug ou suggérez une nouvelle fonctionnalité directement sur GitHub.",
