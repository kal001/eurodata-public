export const translationsFr: Record<string, string> = {
  ...
  heroBody:
    "Connectez banques et cartes dans toute l'Europe.\nNous ne voyons ni ne vendons jamais vos données bancaires—elles sont stockées pour vous seul, chiffrées, avec des fournisseurs de niveau bancaire. Serveurs en Europe. Client open-source que vous pouvez inspecter sur GitHub.\n\nAttribuez des catégories aux transactions automatiquement. Attribuez des étiquettes. Détectez automatiquement les transactions récurrentes.",
  ...
  privacyHighlight5: "Les serveurs de l'application sont situés en Europe.",
  ...
  pricingFeatureExportExcel: "Export des transactions vers Excel ou Google Sheets",
  ...
  pricingFeatureServersGermany: "Serveurs de données en Europe",
  ...
  pricingFaq4A:
    "Vos données sont stockées chiffrées sur des serveurs en Europe. Vous pouvez aussi opter pour un stockage local uniquement.",
