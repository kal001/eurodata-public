export const translationsEn: Record<string, string> = {
  ...
  footerMadeInPortugal: "Made in Portugal",
  footerGithub: "GitHub",
  ...
  helpBack: "Back",
  helpIntro: "Answers to the most common questions. If you can't find what you're looking for, reach out via GitHub.",
  helpGettingStartedTitle: "Getting started",
  helpGettingStartedContent: "After creating an account, go to \"Accounts\" and connect your banks by selecting your country and institution. The connection is made through certified providers — your credentials never pass through our servers.\n\nOnce connected, transactions are imported automatically twice a day. You can also sync manually by clicking the sync icon.",
  helpPageTransactionsTitle: "Transactions and categories",
  helpTransactionsContent: "Transactions are categorised automatically by AI. You can correct any category by clicking on it — the system learns from your corrections over time.\n\nYou can add tags to organise transactions by project, person, or type (personal/business). Tags are also useful for filtering and exporting reports.",
  helpSubscriptionTitle: "Subscription",
  helpSubscriptionContent: "The app includes a free trial period. After that, an active subscription is required to connect automatic banks and receive daily updates.\n\nYou can manage your subscription under \"My Profile\" → \"Subscription\" tab. Each subscription includes 2 automatic accounts; you can add more for €0.75/month each.",
  helpSupportTitle: "Need more help?",
  helpSupportBody: "Didn't find an answer? Report a bug or suggest a new feature directly on GitHub.",
  ...
  aboutIntro:
    "We are a small startup based in Portugal, with a strong belief in user data ownership and privacy. We believe that allowing easy access to consolidated personal financial information enables individuals to make better-informed decisions and contributes to financial literacy and medium-term financial stability.",
