export const translationsEn: Record<string, string> = {
  ...
  pricingFeatureExportExcel: "Export transactions to Excel",
  ...
  pricingFeatureServersGermany: "Data servers located in Europe (Germany)",
  ...
  pricingFaq4A:
    "Your data is stored encrypted on servers in Germany. You can also opt for local-only storage.",
