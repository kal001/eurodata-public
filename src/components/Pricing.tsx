...
export default function Pricing({ t, onBack, onStartTrial }: Props) {
  ...
  const featureRows: (
    ...
    { labelKey: "pricingFeaturePdfImport", premium: true },
    { labelKey: "pricingFeatureAutoCategory", premium: true },
    ...
    { labelKey: "pricingFeatureRecurringDetection", premium: true },
    { labelKey: "pricingFeatureCalendarView" },
    { labelKey: "pricingFeatureExportExcel", premium: true },
    { labelKey: "pricingFeatureBalanceForecast", premium: true },
